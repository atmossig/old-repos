SWEP.PrintName = "Keemstar Gun" -- The name of the weapon
    
SWEP.Author = "bhop"
SWEP.Contact = "bhopsteamcommunity@gmail.com"--Optional
SWEP.Purpose = "FUCKING WHORES"
SWEP.Instructions = "Mouse 1 To Shoot Whores and Reload To Rage"
...
SWEP.Primary.Damage = 10000 --The amount of damage will the weapon do
SWEP.Primary.TakeAmmo = 1 -- How much ammo will be taken per shot
SWEP.Primary.ClipSize = 10008  -- How much bullets are in the mag
SWEP.Primary.Ammo = "Pistol" --The ammo type will it use
SWEP.Primary.DefaultClip = 1090008 -- How much bullets preloaded when spawned
...
SWEP.Primary.Delay = 0.4 -- Delay before the next shot
SWEP.Primary.Force = 133333
