SWEP.PrintName = "CSS AUG" -- The name of the weapon
...
SWEP.Primary.Damage = 43 --The amount of damage will the weapon do
...
SWEP.Primary.DefaultClip = 25 -- How much bullets preloaded when spawned
