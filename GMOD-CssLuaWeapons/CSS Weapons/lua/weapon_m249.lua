SWEP.PrintName = "CSS M249" -- The name of the weapon
...
SWEP.Primary.Damage = 42 --The amount of damage will the weapon do
...
SWEP.Primary.Recoil = .3 -- The amount of recoil
