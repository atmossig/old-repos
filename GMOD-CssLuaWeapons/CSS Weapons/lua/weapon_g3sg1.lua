SWEP.PrintName = "CSS G3SG1" -- The name of the weapon
...
local ShootSound = Sound("Weapon_G3SG1.Single")
SWEP.Primary.Damage = 32 --The amount of damage will the weapon do
SWEP.Primary.TakeAmmo = 1 -- How much ammo will be taken per shot
SWEP.Primary.ClipSize = 16  -- How much bullets are in the mag
